...
//
    ...
    case 11:
     printf(" Lar1 XMIT fake data test \n");
...
//
    ...
    case 16:
     ...
     printf(" enter 1 for testing delay loop, 2 for fake gate \n");
     scanf("%d", &ichoice);
     if(ichoice == 1) {
      printf(" enable number of loop\n");
      scanf("%d",&nloop);
...
/** initialize **/
     ...
     imod=imod_trig;
     buf_send[0]=(imod<<11)+(mb_trig_deadtime_size)+((0x5)<<16); //set trigger deadtime size
     i=1;
     k=1;
    i = pcie_send(hDev, i, k, px);
...
//     }
     ...
     if(ichoice == 2) {
      ...
      imod=imod_trig;
      buf_send[0]=(imod<<11)+(mb_trig_enable)+((0x1)<<16); // enable trigger
      i=1;
      k=1;
      i = pcie_send(hDev, i, k, px);

      imod=imod_trig;
      buf_send[0]=(imod<<11)+(mb_gate_fake_sel)+((0x1)<<16); // Turn on fake sel
      i=1;
      k=1;
      i = pcie_send(hDev, i, k, px);

      imod=imod_trig;
      buf_send[0]=(imod<<11)+(mb_fake_gate_width)+((0x100)<<16); // set the gate width
      i=1;
      k=1;
      i = pcie_send(hDev, i, k, px);

      imod=imod_trig;
      buf_send[0]=(imod<<11)+(mb_scaler_out_sel_0)+((0x800)<<16); // set for scaler 1 output fake gatein
      i=1;
      k=1;
      i = pcie_send(hDev, i, k, px);

      imod=imod_trig;
      buf_send[0]=(imod<<11)+(mb_scaler_out_sel_1)+((0x400)<<16); // set for scaler 2 output gfake
      i=1;
      k=1;
      i = pcie_send(hDev, i, k, px);
      ...
      for (j=0; j<2; j++) {
       ...
       for (k=0; k<nword; k++) {
        ...
        if(k==9) printf("\n");
        read_array_s[k*2] = read_array[k];
        read_array_s[k*2+1] = read_array[k]>> 16;
       }
       printf("\n");
       ...
       printf(" mask 3 = %d \n", (read_array_s[9] & 0xff));
       printf(" mask 4 = %d \n", (read_array_s[10] >>8));
       printf(" mask 5 = %d \n", (read_array_s[10] & 0xff));
       printf(" mask 6 = %d \n", (read_array_s[11] >>8));
       printf(" mask 7 = %d \n", (read_array_s[11] & 0xff));
       printf(" mask 8 = %d \n", ((read_array_s[12] & 0xff) <<8) +(read_array_s[12] >>8));
       printf(" delay size 1 = %d \n", read_array_s[13]);
       printf(" delay size 2 = %d \n", read_array_s[14]);
       ...
       printf(" module number = %d \n", (read_array_s[0] & 0xff));
       printf(" command = %d \n", (read_array_s[0] >> 8));
       printf(" filler word %x \n", read_array_s[1]);
       printf(" frame number = %d \n", read_array[1]);
       printf(" sample number = %d \n", read_array_s[4]);
       printf(" div = %d\n", read_array_s[5]);
       printf(" trigger number = %d \n", read_array[3]);
       printf(" trigger counter 0 = %d \n", read_array[4]);
       printf(" trigger counter 1 = %d \n", read_array[5]);
       printf(" trigger counter 2 = %d \n", read_array[6]);
       printf(" trigger counter 3 = %d \n", read_array[7]);
       printf(" trigger counter 4 = %d \n", read_array[8]);
       printf(" trigger counter 5 = %d \n", read_array[9]);
       printf(" trigger counter 6 = %d \n", read_array[10]);
       printf(" trigger counter 7 = %d \n", read_array[11]);
       ...
       printf(" div = %d\n", read_array_s[5]);
       printf(" trigger number = %d \n", read_array[3]);
       printf(" PMT counter 0 = %d \n", read_array[4]);
       printf(" PMT counter 1 = %d \n", read_array[5]);
       printf(" PMT counter 2 = %d \n", read_array[6]);
       printf(" PMT counter 3 = %d \n", read_array[7]);
       printf(" PMT counter 4 = %d \n", read_array[8]);
       printf(" PMT counter 5 = %d \n", read_array[9]);
       printf(" PMT counter 6 = %d \n", read_array[10]);
       printf(" PMT counter 7 = %d \n", read_array[11]);
       
       nword =2;
       i = pcie_rec(hDev,0,1,nword,iprint,py);     // init the receiver
       imod=imod_trig;
       buf_send[0]=(imod<<11)+(ichip<<8)+mb_version+(0x0<<16);  // read out status
       i=1;
       k=1;
       i = pcie_send(hDev, i, k, px);
       py = &read_array;
...
//       imod=11;    enable test on to get slow control       //tempory
       imod= imod_fem;
       ichip=3;
       buf_send[0]=(imod<<11)+(ichip<<8)+10+(0x1<<16);    // enable a test n
       i=1;
       k=1;
       i = pcie_send(hDev, i, k, px);
