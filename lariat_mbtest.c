...
int main(void)
{
  ...
  printf("\nStart time of program: %ld sec %ld usec\n",seconds,useconds);
    ...
    /* if (NEVISPCI_DEFAULT_VENDOR_ID) */
    /*     hDev2 = DeviceFindAndOpen(NEVISPCI_DEFAULT_VENDOR_ID, NEVISPCI_DEFAULT_DEVICE_ID); */
...
static void MenuMain(WDC_DEVICE_HANDLE *phDev, WDC_DEVICE_HANDLE *phDev2)
{
    ...
    do
    {
        ...
        printf("%d. Find and open a NEVISPCI device\n", MENU_MAIN_FIND_AND_OPEN);
        if (*phDev)
        {
...
//      if(inewcode ==1 ) inpf = fopen("/home/ub/feb_pmt_fpga_test_new","r");
      ...
      else if(inewcode ==2) inpf = fopen("/home/ub/feb_pmt_fpga_test_new_head","r");
